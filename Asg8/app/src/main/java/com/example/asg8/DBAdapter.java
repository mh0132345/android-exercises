...
public class DBAdapter {
    ...
    public long addContact(int id, String firstName, String lastName, String phone,
                           String education, String hobbies, String date) {
    ...
    public Cursor getContactByFirstName(String firstname) {
    ...
    // Update a contact
    public boolean updateContact(long rowID, String firstName, String lastName, String phone,
                                 String education, String hobbies, String date) {
